...
from .config import CUSTOM_API_BASE, CUSTOM_API_KEY, GEMINI_API_KEY, NVIDIA_API_KEY, OPENAI_API_KEY
...
class LLMClient:
    ...
    def chat(
        self, messages: List[Dict[str, str]], temperature: float = 0.5, fast: bool = False
    ) -> str:
        """
