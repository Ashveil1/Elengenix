...
class CommandSuggester:
    ...
    COMMANDS = {
        ...
        "autonomous": {
            ...
            "examples": [
                "elengenix autonomous https://target.com",
                "elengenix autonomous target.com --mode auto",
            ],
            "category": "core",
        ...
        "scan": {
            ...
            "examples": [
                "elengenix scan target.com",
                "elengenix scan https://api.target.com --rate-limit 10",
            ],
            "category": "scanning",
            "requires_target": True,
            "aliases": ["quick", "s"],
        ...
        "research": {
            ...
            "examples": [
                "elengenix research CVE-2024-21626",
                "elengenix research rce",
                "elengenix research sqli",
            ],
            "category": "research",
            "requires_target": False,
            "aliases": ["cve", "lookup"],
        ...
        "poc": {
            ...
            "examples": [
                "elengenix poc rce --framework spring-boot",
                "elengenix poc sqli > poc.py",
            ],
            "category": "research",
            "requires_target": False,
        ...
        "bola": {
            ...
            "examples": [
                "elengenix bola https://api.target.com",
        ...
        "waf": {
            ...
            "examples": [
                "elengenix waf https://target.com/login",
