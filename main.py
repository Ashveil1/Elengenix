...
def main():
    ...
    try:
        if args.command == "scan":
            ...
            if not args.target:
                console.print(
                    "Usage: elengenix poc <vuln-type> [--framework <name>] [--version <ver>]"
                )
                console.print("Examples:")
            ...
            try:
                ...
                if result.get("status") == "success":
                    ...
                    console.print(
                        "[dim]Note: You can still use Elengenix without CVE database updates.[/dim]"
                    )
            except Exception as e:
...
def _cmd_list_tools():
    ...
    console.print()
    console.print(
        f"[bold red]Elengenix Tool Catalog[/bold red] [dim]({len(all_tools)} tools registered)[/dim]"
    )
    console.print()
...
def _cmd_scan_report(args):
    ...
    if not findings_file:
        console.print(
            "[red]Usage:[/red] elengenix scan-report <findings.json> [--format html|md|sarif|json|txt|all]"
        )
        return
