"""elengenix/agent/agent_skills.py — Reusable procedure/technique store.

Skills are named procedures the AI can save and reuse across sessions.
Backed by JSON file under ~/.elengenix/data/skills.json.
"""
...
logger = logging.getLogger("elengenix.agent.agent_skills")
...
class SkillStore:
    ...
    _SKILLS_DIR = ELENGENIX_HOME / "data"
