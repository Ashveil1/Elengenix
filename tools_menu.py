...
TOOLS: List[Dict[str, str]] = [
    ...
    {"name": "Cloud/IaC Reviewer", "file": "cloud_reviewer.py", "desc": "Scan Terraform, Kubernetes, and AWS configs"},
    {"name": "Mobile API Fuzzer", "file": "mobile_fuzzer.py", "desc": "Analyze and fuzz mobile application endpoints"},
