...
def test_full_pipeline_modules_importable():
    ...
    """
    # Core engine
    from scan_engine_upgrade import SmartOrchestrator, ParallelRunner, ScanState, FindingCorrelator
    ...
    from orchestrator import run_standard_scan, is_in_scope, is_valid_target
