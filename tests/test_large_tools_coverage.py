    ...
    def test_missing(self):
        ...
        t = T(
            ToolMetadata(
                ...
                category=ToolCategory.SCANNER,
                priority=ToolPriority.LOW,
                binary_name="nonexistent_binary_xyz_999",
                description="d",
            )
        )
...
class TestScoreDelta:
    ...
    def test_combined_signals(self):
        ...
        score, _ = score_delta(
            self._delta(error_indicator=True, auth_indicator=True, sql_error_in_body=True)
        )
        assert score > 0.5
...
class TestLogicFinding:
    ...
    def test_auto_cwe(self):
        ...
        f = LogicFinding(
            title="t", target="x", endpoint="/api", category=DetectorCategory.AUTH_LOGIC
        )
        assert len(f.cwe) > 0
...
class TestNormalizeEndpoint:
    ...
    def test_dict_input(self):
        ...
        ep = normalize_endpoint(
            {"url": "https://example.com/api", "method": "post", "body": {"name": "t"}}
        )
...
class TestPriceManipulationDetector:
    def test_negative_amount(self):
        ...
        findings = _run_async(
            det.detect("target", [{"url": "https://api.com/pay", "body": {"price": 10}}])
        )
    ...
    def test_quantity(self):
        ...
        findings = _run_async(
            PriceManipulationDetector().detect(
                "target", [{"url": "https://api.com/order", "body": {"quantity": 5}}]
            )
        )
    ...
    def test_no_price_endpoint(self):
        ...
        findings = _run_async(
            PriceManipulationDetector().detect(
                "target", [{"url": "https://api.com/users", "body": {"name": "t"}}]
            )
        )
    ...
    def test_discount_stacking(self):
        ...
        findings = _run_async(
            PriceManipulationDetector().detect(
                "target", [{"url": "https://api.com/coupon/apply", "body": {"coupon": "SAVE20"}}]
            )
        )
...
class TestRaceConditionDetector:
    def test_detect_on_transfer(self):
        ...
        findings = _run_async(
            RaceConditionDetector().detect(
                "target", [{"url": "https://api.com/transfer", "method": "POST"}]
            )
        )
    ...
    def test_no_race_on_get(self):
        ...
        findings = _run_async(
            RaceConditionDetector().detect(
                "target", [{"url": "https://api.com/transfer", "method": "GET"}]
            )
        )
        assert len(findings) == 0
...
class TestStateMachineBypassDetector:
    def test_step_param(self):
        ...
        findings = _run_async(
            StateMachineBypassDetector().detect(
                "target", [{"url": "https://api.com/onboard", "params": {"step": "3"}}]
            )
        )
    ...
    def test_deep_link(self):
        ...
        findings = _run_async(
            StateMachineBypassDetector().detect(
                "target", [{"url": "https://api.com/wizard/step-3"}]
            )
        )
    ...
    def test_admin_path(self):
        ...
        findings = _run_async(
            StateMachineBypassDetector().detect(
                "target", [{"url": "https://api.com/admin/dashboard"}]
            )
        )
...
class TestAuthLogicDetector:
    def test_password_reset(self):
        ...
        findings = _run_async(
            AuthLogicDetector().detect("target", [{"url": "https://api.com/reset-password"}])
        )
    ...
    def test_2fa_bypass(self):
        ...
        findings = _run_async(
            AuthLogicDetector().detect("target", [{"url": "https://api.com/verify-otp"}])
        )
    ...
    def test_session_fixation(self):
        ...
        findings = _run_async(
            AuthLogicDetector().detect("target", [{"url": "https://api.com/login"}])
        )
    ...
    def test_oauth_missing_state(self):
        ...
        findings = _run_async(
            AuthLogicDetector().detect(
                "target",
                [
                    {
                        "url": "https://api.com/authorize",
                        "params": {"redirect_uri": "http://evil.com"},
                    }
                ],
            )
        )
...
class TestAuthorizationDetector:
    def test_sequential_ids(self):
        ...
        findings = _run_async(
            AuthorizationDetector().detect(
                "target",
                [
                    {"url": "https://api.com/users/1"},
                    {"url": "https://api.com/users/2"},
    ...
    def test_role_param(self):
        ...
        findings = _run_async(
            AuthorizationDetector().detect(
                "target", [{"url": "https://api.com/settings", "body": {"role": "admin"}}]
            )
        )
    ...
    def test_admin_path(self):
        ...
        findings = _run_async(
            AuthorizationDetector().detect("target", [{"url": "https://api.com/admin/users"}])
        )
        assert any("bfla" in f.tags for f in findings)
    ...
    def test_multi_tenant(self):
        ...
        findings = _run_async(
            AuthorizationDetector().detect("target", [{"url": "https://api.com/org/123/data"}])
        )
...
class TestWorkflowIntegrityDetector:
    def test_missing_idempotency(self):
        ...
        findings = _run_async(
            WorkflowIntegrityDetector().detect(
                "target", [{"url": "https://api.com/pay", "method": "POST", "body": {"amount": 10}}]
            )
        )
...
class TestBusinessConstraintDetector:
    def test_client_timestamp(self):
        ...
        findings = _run_async(
            BusinessConstraintDetector().detect(
                "target", [{"url": "https://api.com/order", "body": {"timestamp": "2024-01-01"}}]
            )
        )
    ...
    def test_kyc_bypass(self):
        ...
        findings = _run_async(
            BusinessConstraintDetector().detect(
                "target", [{"url": "https://api.com/trade", "body": {"verified": "true"}}]
            )
        )
...
class TestCorrelationEngine:
    def test_race_bola_chain(self):
        ...
        f1 = LogicFinding(
            title="race", target="x", endpoint="/pay", category=DetectorCategory.RACE_CONDITION
        )
        f1.tags = ["race"]
        f2 = LogicFinding(
            title="bola", target="x", endpoint="/users/1", category=DetectorCategory.AUTHORIZATION
        )
...
class TestLogicFlawBackCompat:
    def test_logic_flaw(self):
        ...
        f = LogicFlaw(
            flaw_type="xss", endpoint="/api", description="test", severity="High", confidence=0.8
        )
...
class TestUnmaintained:
    def test_deprecated(self):
        ...
        assert (
            len(check_unmaintained([Component(name="request", version="2.28", ecosystem="npm")]))
            > 0
        )
    ...
    def test_maintained(self):
        ...
        assert (
            len(check_unmaintained([Component(name="express", version="4.18", ecosystem="npm")]))
            == 0
        )
...
class TestUniversalExecutor:
    ...
    def test_write_action(self):
        ...
        r = self._executor(d).execute_action(
            {"type": "write_file", "params": {"path": p, "content": "hi"}}
        )
        assert r.success
    ...
    def test_search_action(self):
        ...
        Path(p).write_text("hello world")
        r = self._executor(d).execute_action(
            {"type": "search_file", "params": {"path": p, "pattern": "hello"}}
        )
        assert r.success
