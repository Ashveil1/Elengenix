...
async def cmd_compliance(args):
    ...
    try:
        ...
        console.print(f"  [green]Passed:[/green] {assessment['passed']}  "
        ...
        console.print(f"  Risk level: [{'red' if assessment.get('critical_failures',0) > 0 else 'green'}]{assessment['risk_level']}[/]")
    except Exception as e:
