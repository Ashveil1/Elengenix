"""
core/brain.py — Backward-compatibility shim for ElengenixAgent.

WARNING: This module is **deprecated**. All new code should import
directly from ``elengix.scanning`` or ``tools.*`` as documented.
...
def _analyze_intent(client: Any, query: str) -> str:
    """Lightweight intent classifier — delegates to elengix.scanning."""
    try:
...
class ElengenixAgent:
    ...
    ``elengix.scanning``.  Prefer those modules for new code.
    """
